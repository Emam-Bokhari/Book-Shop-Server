...
const getAllOrdersController = (0, asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield order_service_1.OrderServices.getAllOrders(query);
    (0, sendResponse_1.sendResponse)(res, {
      success: true,
...
const getOrderController = (0, asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getUserOrdersHistoryController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const query = req.query;
      // const userEmail = req.user.email;
      const result = yield order_service_1.OrderServices.getUserOrdersHistory(
        loggedInUserEmail,
        requestedUserEmail,
        query,
      );
...
const updateOrderStatusController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const updatedStatus =
        yield order_service_1.OrderServices.updateOrderStatusById(id, status);
      (0, sendResponse_1.sendResponse)(res, {
        success: true,
