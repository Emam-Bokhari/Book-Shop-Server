...
router.get('/order-history', (0, auth_1.auth)(user_constant_1.USER_ROLE.user, user_constant_1.USER_ROLE.admin), order_controller_1.OrderControllers.getUserOrdersHistoryController);
