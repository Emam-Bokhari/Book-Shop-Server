  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const paymentResponse =
        yield sslcommerz_service_1.SSLCommerzService.initiatePayment({
...
const getAllOrders = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result.length === 0) {
      throw new HttpError_1.HttpError(
        404,
        'No order were found in the database',
      );
    }
    return {
      meta,
...
const getUserOrdersHistory = (loggedInUserEmail, requestedUserEmail, query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userOrderQuery = new QueryBuilder_1.default(
      order_model_1.Order.find({ userId: user._id }).populate('userId'),
      query,
    );
...
const updateOrderStatusById = (id, status) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedStatus = yield order_model_1.Order.findOneAndUpdate(
      { _id: id },
      { status: status },
